...
var app = document.querySelector('#app'); // patch(oldVnode, newVnode) 
// init返回的patch函数有两个参数。第一个是表示当前视图的DOM元素或vnode。第二个是表示更新后的新视图的vnode

var patch = (0, _snabbdom.init)([]); // snabbdom/h创建虚拟节点（vnodes）。h函数接收一个字符串形式的标签/选择器、一个可选的数据对象、一个可选的字符串或数组作为子代

var vnode = (0, _snabbdom.h)('div', [(0, _snabbdom.h)('h1', 'hello snabbdom'), (0, _snabbdom.h)('p', 'content p')]);
var oldVnode = patch(app, vnode);
setTimeout(function () {
  vnode = (0, _snabbdom.h)('div', [(0, _snabbdom.h)('h1', 'hello snabbdom 233333'), (0, _snabbdom.h)('p', '5s后清空dom')]);
  oldVnode = patch(oldVnode, vnode);
}, 2333);
setTimeout(function () {
  oldVnode = patch(oldVnode, (0, _snabbdom.h)('!')); // vnode = '!' 注释节点
}, 5000);
},{"snabbdom":"node_modules/snabbdom/es/snabbdom.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","src/01-basicusage.js"], null)
